...
```
For the Goodness of fit test we obtained a p-value = `r round(phl.new,3)`. For a 5% significance level with do not reject the null hypothesis of Good fit.
...
Comparison between new and stepwise models:
```{r}
